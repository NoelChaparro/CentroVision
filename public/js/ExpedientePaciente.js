	...
	$.ajax({
            ...
            success:  function (response) {
            	$.each(response.Paciente, function(i,elemento){
                    ...
                    CKEDITOR.instances['CirugiaOcularExtraocular'].setData("<p style='text-align: center;'><b>CONSENTIMIENTO INFORMADO DE CIRUGIA OCULAR Y EXTRAOCULAR</b></p><p style='text-align:justify;'><b>Paciente:</b> " + elemento.Nombre + " Autorizo al Cirujano Oftalmólogo Dr. Jesus Gerardo Contreras Herrera para que efectué las intervenciones quirúrjicas que sean necesarias para aliviar o curar mi padecimiento de: " + txtConcentimientoCirugiaOcularExtraocular+"</p>");
...
txtConcentimientoCirugiaOcularExtraocular = "<p style='text-align:justify;'>1.- RIESGOS Y COMLICACIONES: Se da la autorización bajo la comprensión de que cualquier operación o procedimiento implica riesgos y peligros que incluyen: infección ocular externa o interna (endoftalmitis) hemorragia expulsiva, perdida de vítreo, desprendimiento de retina o coroides, maculopatía, glaucoma y queratopatía, etc. Otras Incluyen:</p>";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "<p style='text-align:justify;'>2.- ANESTESIA: Existe la anestesia general y regional (local), la administración de anestésicos, también implica riesgos, el más importante aunque poco frecuente, es el riesgo de sufrir alguna reacción a los medicamentos usados en la anestesia general, que pueden causar la muerte, autorizo el uso de estos anestésicos por la persona responsable de este servicio en caso de que lo considere necesario.</p>";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "<p style='text-align:justify;'>Anestesia Regional (local) retrobulbar tiene ventajas y desventajas, que incluyen complicaciones asociadas, estas pueden ser divididas en dos grupos: A) Relacionadas con el compromiso de la visión como son: daño al nervio óptico, oclusión de la arteria central de la retina, hemorragia retrobulbar, perforación ocular, émbolos a la circulación retiniana o coroidea. B) Relacionadas con el compromiso de la vida como son: Paro Cardiaco, Depresión Respiratoria, y Depresión del Sistema Nervioso.</p>";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "<p style='text-align:justify;'>3.- ESTOY enterado (a) de que no existe garantía o seguridad sobre los resultados del procedimiento quirúrgico de cirugía de catarata y que no pueda curar mi enfermedad.</p><p style='text-align:justify;'>4.- NADIE puede predecir cuales serán las complicaciones que ocurran en mi caso.</p>";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "<p style='text-align:justify;'>5.- EN OCASIONES es necesario realizar un segundo o tercer procedimiento quirúrgico dependiendo del diagnóstico prequirúrgico y complicaciones transquirúrgicas o postoperatorias, se da la autorización del procedimiento que mi Médico considere necesario en el momento de la operación.</p>";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "<p style='text-align:justify;'>CONSENTIMIENTO DE PACIENTE: Tengo que leer o que me lean y entender esta forma de consentimiento y NO DEBO FIRMARLA si todos los párrafos o todas mis dudas no han sido explicadas o contestadas a mi entera satisfacción o si no entiendo cualquier termino medico o palabra contenida en este documento.</p>";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "<p style='text-align:justify;'>Si tiene cualquier duda de los riesgos o peligros de la cirugía o tratamiento propuesto, pregunte a su Cirujano (antes de firmar este documento).</p><p>NO FIRME A MENOS QUE LE LEAN O EXPLIQUEN Y ENTIENDA ESTE CONSENTIMIENTO.</p>";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "<table><tr><td>_______________________________________________</td><td>_______________________________________________</td></tr><tr><td>Paciente o Responsable Legal</td><td>Testigo</td></tr></table>";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "DECLARACION MEDICA: He explicado el contenido de éste documento al paciente, he respondido a todas sus preguntas al grado máximo de mi conocimiento, creo que el paciente ha sido informado adecuadamente y he aceptado operarlo.";
txtConcentimientoCirugiaOcularExtraocular = txtConcentimientoCirugiaOcularExtraocular + "<table><tr><td>_______________________________________________</td><td></td></tr><tr><td style='text-align:center;'>Firma del Médico</td><td>Cd. Cuauhtémoc, Chih. a "+f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear()+"</td></tr></table>";
